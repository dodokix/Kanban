...
/*
=======================================================================================
GESTIONE CARD E INIZIALIZZAZIONE
======================================================================================
*/
...
Card* create_card(const char* text, int user_port) {
    ...
    new_card->text[strcspn(new_card->text, "\n\r")] = '\0';
...
/*
==========================================================================================
    FUNZIONI PER L'ASTA E SCAMBIO MESSAGGI
==========================================================================================
*/
...
void handle_console(Message* msg){
    if(strncmp(msg->text, "create", strlen("create")) == 0){
        ...
        printf("[WARN] Comando console non riconosciuto: '%s'\n", msg->text);
    }
}
